...
// LOCAL HEADER FILES (common/shared)
#include "../common_headers/config_variables.h"
#include "../common_headers/persistent_variables.h"
#include "../common_headers/global_variables.h"
#include "../common_headers/scaling.h"
#include "../common_headers/helper_functions.h"

// Device selection (change DEVICE_TYPE in device_config.h)
